...
let getTargetMonth = function(misson, accumulatedMonth) {
  return misson / accumulatedMonth;
}

// 7
console.log('Цель будет достигнута за месяцев:', Math.ceil(getTargetMonth(mission, getAccumulatedMonth)));
